...
export class SlackHandlers {
  ...
  /** public method likely to be called by MQs in otber actors (bitActor, scheduleActor, webActor) */
  ...
  async handlePullRequest(slackMessage, userString) {
  ...
  async handleBuild(slackMessage, userString) {
    const payload = {
